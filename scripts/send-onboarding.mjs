...
const PREVIEW_QUESTIONS = {
  ...
  restaurant: ["점심/저녁 메뉴가 뭔가요?", "예약 필요한가요?", "단체 가능한가요?", "배달 되나요?"],
  ...
  nail:       ["젤네일 가격은요?", "얼마나 걸려요?", "예약 필수인가요?", "위생 관리는요?"],
  academy:    ["어떤 과목 가르치나요?", "수업료는요?", "레벨테스트 있나요?", "체험 수업 있나요?"],
  medical:    ["진료 예약은 어떻게 하나요?", "건강보험 적용되나요?", "주차 가능한가요?", "대기 시간은요?"],
  pet:        ["미용 가격은요?", "예방접종 확인 필요한가요?", "예약 필요한가요?", "노령 동물도 가능한가요?"],
  realestate: ["담당 지역이 어디인가요?", "중개 수수료는요?", "전세/월세 매물 있나요?", "방문 예약 어떻게 해요?"],
  shopping:   ["배송 기간은요?", "교환/반품 기간은요?", "배송비는요?", "선물 포장 되나요?"],
  car_repair: ["엔진오일 교환 가격은요?", "예약 필요한가요?", "수리 견적 받을 수 있나요?", "보험 수리 가능한가요?"],
};
